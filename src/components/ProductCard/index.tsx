        ...
        {!products ? "" : products?.map((product: IProduct) => {
            return (
                ...
                <div className="relative flex">
                    <img className="" src="https://tailwind-ecommerce-demo.vercel.app/product-chair.43cea4c5.png"
                        alt="sofa image" />
                ...
                <div>
                    ...
                    <div>
                        <button onClick={ () => addCart(product?._id)} className="my-5 h-10 w-full bg-violet-900 text-white">
                            Add to cart
                        </button>
                    </div>
                </div>
