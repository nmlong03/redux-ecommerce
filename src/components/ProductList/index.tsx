...
const ProductList = () => {
  ...
  const userId = '64ac156fb45f9e1baad937c0'
  console.log(userId);
      ...
      <section className="bg-white py-12 text-gray-700 sm:py-16 lg:py-20">
        <div className="mx-auto max-w-screen-xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-10 grid grid-cols-2 gap-6 sm:grid-cols-4 sm:gap-4 lg:mt-16">
            {isLoading ? <Skeleton /> : productData?.data?.map((product: IProduct) => {
              return <article key={product?._id} className="relative flex flex-col overflow-hidden rounded-lg border">
                  ...
                  <button onClick={() =>addCart(product?._id)} className="group mx-auto mb-2 flex h-10 w-10/12 items-stretch overflow-hidden rounded-md text-gray-600">
