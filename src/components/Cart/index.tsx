...
const Cart = () => {
  ...
  >({});
  const [deleteItemCart, { isLoading: isDeleteLoading }] =
  ...
  const total = cart?.carts?.reduce(function (sum: number, item: any) {
                  ...
                  <div className="flex w-2/5">
                    ...
                    <div className="flex flex-col justify-between ml-4 flex-grow">
                      ...
                      <Popconfirm
                        ...
                        cancelText="No"
                      >
                       {isDeleteLoading && removeLoadingMap[item.productId] ? (
                        <div><Spin/></div>
                        ) : (
                          <div className="text-red-500"><AiFillDelete/>
                          </div>
